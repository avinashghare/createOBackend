...
<h3 class="panel-title">userlog Details </h3>
</header>
<div class="panel-body">
<form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/edituserlogsubmit");?>' enctype= 'multipart/form-data'>
...
<div class="col-sm-4">
<?php echo form_dropdown("deciese",$deciese,set_value('deciese',$before->deciese),"class='chzn-select form-control'");?>
</div>
</div>
<div class="form-group">
